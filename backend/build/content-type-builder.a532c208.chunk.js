...
const AttributeList = ({ attributes }) => /* @__PURE__ */ react.createElement(dist.KeyboardNavigable, { tagName: "button" }, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 8 }, attributes.map((attributeRow, index) => {
  return (
...
const CustomFieldsList = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.KeyboardNavigable, { tagName: "button" }, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 3 }, /* @__PURE__ */ react.createElement(dist.Grid, { gap: 0 }, sortedCustomFields.map(([uid, customField], index) => {
...
const FormModalHeader = ({
  ...
  return /* @__PURE__ */ react.createElement(dist.ModalHeader, null, /* @__PURE__ */ react.createElement(dist.Stack, { horizontal: true, spacing: 3 }, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type: icon, customField: customFieldUid }), /* @__PURE__ */ react.createElement(dist.Breadcrumbs, { label: breadcrumbsLabel }, headers.map((header, index) => {
...
const FormModalSubHeader = ({
  ...
  return /* @__PURE__ */ react.createElement(dist.Stack, { direction: "column", alignItems: "flex-start", paddingBottom: 2, gap: 1 }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h2", variant: "beta" }, formatMessage(
    {
...
const Wrapper = (0,styled_components_browser_esm["default"])(dist.Stack)`
  position: relative;
  align-items: stretch;
...
const CustomRadioGroup = ({ intlLabel, name, onChange, radios, value }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800", htmlFor: name, as: "label" }, formatMessage(intlLabel)), /* @__PURE__ */ react.createElement(Wrapper, { horizontal: true, spacing: 4, style: { alignItems: "stretch" } }, radios.map((radio) => {
    ...
    ), /* @__PURE__ */ react.createElement(dist.Box, { className: "option", padding: 4 }, /* @__PURE__ */ react.createElement(dist.Flex, null, /* @__PURE__ */ react.createElement(dist.Box, { paddingRight: 4 }, /* @__PURE__ */ react.createElement("span", { className: "checkmark" })), /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(dist.Typography, { fontWeight: "bold" }, formatMessage(radio.title)), /* @__PURE__ */ react.createElement(dist.Typography, { variant: "pi", textColor: "neutral600" }, formatMessage(radio.description))))));
  })));
};
...
const CheckboxWithNumberField = ({ error, intlLabel, modifiedData, name, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(
    dist.Checkbox,
    {
      id: name,
      name,
...
const FormModal = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.ModalLayout, { onClose: handleClosed, labelledBy: "title" }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6 }, /* @__PURE__ */ react.createElement(dist.TabPanels, null, /* @__PURE__ */ react.createElement(dist.TabPanel, null, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(
      components_TabForm,
      {
        form: baseForm,
        formErrors,
    ...
    ))), /* @__PURE__ */ react.createElement(dist.TabPanel, null, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(
      components_TabForm,
      {
        form: advancedForm,
        formErrors,
...
const ContentTypeBuilderNav = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ), section.customLink && /* @__PURE__ */ react.createElement(dist.Box, { paddingLeft: 7 }, /* @__PURE__ */ react.createElement(dist.TextButton, { onClick: section.customLink.onClick, startIcon: /* @__PURE__ */ react.createElement(icons_dist.Plus, null), marginTop: 2 }, formatMessage({
