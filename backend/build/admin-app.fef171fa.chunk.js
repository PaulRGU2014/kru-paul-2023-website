...
const ForgotPassword = ({ onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    formik_dist.Formik,
    {
    ...
    ({ values, errors, handleChange }) => /* @__PURE__ */ react.createElement(helper_plugin.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* Column */.sg, null, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6, paddingBottom: 7 }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h1", variant: "alpha" }, formatMessage({
    ...
    )), /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(
      dist.TextInput,
      {
    ...
    ), /* @__PURE__ */ react.createElement(dist.Button, { type: "submit", fullWidth: true }, formatMessage({
      id: "Auth.form.button.forgot-password",
      defaultMessage: "Send Email"
    }))))
  )), /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(helper_plugin.Link, { to: "/auth/login" }, formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }))))));
};
...
const ForgotPasswordSuccess = () => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* Column */.sg, null, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6, paddingBottom: 7 }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h1", variant: "alpha" }, formatMessage({
  ...
  })), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(dist.Typography, null, formatMessage({
  ...
  }))))), /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(helper_plugin.Link, { to: "/auth/login" }, formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }))))));
};
...
const Oops = () => {
  const { formatMessage } = (0,react_intl.useIntl)();
  const query = (0,helper_plugin.useQuery)();
  const message = query.get("info") || formatMessage({
    id: "Auth.components.Oops.text",
    defaultMessage: "Your account has been suspended."
  });
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* Column */.sg, null, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6, paddingBottom: 7 }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h1", variant: "alpha" }, formatMessage({ id: "Auth.components.Oops.title", defaultMessage: "Oops..." }))), /* @__PURE__ */ react.createElement(dist.Typography, null, message), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(dist.Typography, null, formatMessage({
...
const CenteredBox = (0,styled_components_browser_esm["default"])(dist.Box)`
  text-align: center;
`;
const A = styled_components_browser_esm["default"].a`
  color: ${({ theme }) => theme.colors.primary600};
`;
const PasswordInput = (0,styled_components_browser_esm["default"])(dist.TextInput)`
  ::-ms-reveal {
    display: none;
  }
`;
const Register = ({ authType, fieldsToDisable, noSignin, onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    ...
    ({ values, errors, handleChange }) => {
      return /* @__PURE__ */ react.createElement(helper_plugin.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* Column */.sg, null, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h1", variant: "alpha" }, formatMessage({
        id: "Auth.form.welcome.title",
        defaultMessage: "Welcome to Strapi!"
      }))), /* @__PURE__ */ react.createElement(CenteredBox, { paddingBottom: 7 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "epsilon", textColor: "neutral600" }, formatMessage({
        id: "Auth.form.register.subtitle",
        defaultMessage: "Credentials are only used to authenticate in Strapi. All saved data will be stored in your database."
      })))), /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(dist.Grid, { gap: 4 }, /* @__PURE__ */ react.createElement(dist.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(
        dist.TextInput,
        {
          name: "firstname",
          required: true,
        ...
        PasswordInput,
        {
          ...
          endAction: (
            ...
            /* @__PURE__ */ react.createElement(
              ...
              confirmPasswordShown ? /* @__PURE__ */ react.createElement(icons_dist.Eye, null) : /* @__PURE__ */ react.createElement(icons_dist.EyeStriked, null)
            )
          ),
          required: true,
          label: formatMessage({
      ...
      ), /* @__PURE__ */ react.createElement(dist.Button, { fullWidth: true, size: "L", type: "submit" }, formatMessage({
        id: "Auth.form.button.register",
        defaultMessage: "Let's start"
      })))));
    }
  ), !noSignin && /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(helper_plugin.Link, { label: "Auth.link.signin", to: "/auth/login" }, formatMessage({
...
const ResetPassword_PasswordInput = (0,styled_components_browser_esm["default"])(dist.TextInput)`
  ::-ms-reveal {
    display: none;
  }
`;
const ResetPassword_ForgotPassword = ({ onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    ...
    ), /* @__PURE__ */ react.createElement(dist.Button, { fullwidth: true, type: "submit" }, formatMessage({
...
var Login=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(9442)/* ["default"] */ .Z);}return (__webpack_require__(73347)/* ["default"] */ .Z);}();var forms_forms={'forgot-password':{Component:components_ForgotPassword,endPoint:'forgot-password',fieldsToDisable:[],fieldsToOmit:[],schema:lib/* object */.Ry().shape({email:lib/* string */.Z_().email(helper_plugin.translatedErrors.email).required(helper_plugin.translatedErrors.required)}),inputsPrefix:''},'forgot-password-success':{Component:components_ForgotPasswordSuccess,endPoint:'',fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},login:{Component:Login,endPoint:'login',fieldsToDisable:[],fieldsToOmit:['rememberMe'],schema:lib/* object */.Ry().shape({email:lib/* string */.Z_().email(helper_plugin.translatedErrors.email).required(helper_plugin.translatedErrors.required),password:lib/* string */.Z_().required(helper_plugin.translatedErrors.required),rememberMe:lib/* bool */.Xg().nullable()}),inputsPrefix:''},oops:{Component:components_Oops,endPoint:null,fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},register:{Component:components_Register,endPoint:'register',fieldsToDisable:['email'],fieldsToOmit:['userInfo.confirmPassword','userInfo.news','userInfo.email'],schema:lib/* object */.Ry().shape({firstname:lib/* string */.Z_().trim().required(helper_plugin.translatedErrors.required),lastname:lib/* string */.Z_(),password:lib/* string */.Z_().min(8,helper_plugin.translatedErrors.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin.translatedErrors.required),confirmPassword:lib/* string */.Z_().oneOf([lib/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin.translatedErrors.required),registrationToken:lib/* string */.Z_().required(helper_plugin.translatedErrors.required)}),inputsPrefix:'userInfo.'},'register-admin':{Component:components_Register,endPoint:'register-admin',noSignin:true,fieldsToDisable:[],fieldsToOmit:['confirmPassword','news'],schema:lib/* object */.Ry().shape({firstname:lib/* string */.Z_().trim().required(helper_plugin.translatedErrors.required),lastname:lib/* string */.Z_(),password:lib/* string */.Z_().min(8,helper_plugin.translatedErrors.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin.translatedErrors.required),email:lib/* string */.Z_().email(helper_plugin.translatedErrors.email).strict().lowercase(helper_plugin.translatedErrors.lowercase).required(helper_plugin.translatedErrors.required),confirmPassword:lib/* string */.Z_().oneOf([lib/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin.translatedErrors.required)}),inputsPrefix:''},'reset-password':{Component:ResetPassword,endPoint:'reset-password',fieldsToDisable:[],fieldsToOmit:['confirmPassword'],schema:lib/* object */.Ry().shape({password:lib/* string */.Z_().min(8,helper_plugin.translatedErrors.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin.translatedErrors.required),confirmPassword:lib/* string */.Z_().oneOf([lib/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin.translatedErrors.required)})}};/* harmony default export */ const utils_forms = (forms_forms);
...
const PrivateRoute = ({ component: Component, path, ...rest }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    {
      path,
      render: (props) => helper_plugin.auth.getToken() !== null ? /* @__PURE__ */ react.createElement(Component, { ...rest, ...props }) : /* @__PURE__ */ react.createElement(
...
if(!AuthPage_forms[authType]||hasAdmin&&authType==='register-admin'||helper_plugin.auth.getToken()){return/*#__PURE__*/react.createElement(react_router_dom_min.Redirect,{to:"/"});}// Redirect the user to the register-admin if it is the first user
...
const TypographyCenter = (0,styled_components_browser_esm["default"])(dist.Typography)`
  text-align: center;
`;
const UseCasePage = () => {
  const toggleNotification = (0,helper_plugin.useNotification)();
  ...
  const { firstname, email } = helper_plugin.auth.getUserInfo();
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(dist.Main, { labelledBy: "usecase-title" }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement("form", { onSubmit: () => handleSubmit(false) }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", paddingBottom: 7 }, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6, paddingBottom: 1, width: (0,helper_plugin.pxToRem)(250) }, /* @__PURE__ */ react.createElement(TypographyCenter, { variant: "alpha", as: "h1", id: "usecase-title" }, formatMessage({
    id: "Usecase.title",
    ...
    options.map(({ intlLabel, value }) => /* @__PURE__ */ react.createElement(dist.Option, { key: value, value }, formatMessage(intlLabel)))
  ...
  ), /* @__PURE__ */ react.createElement(dist.Button, { type: "submit", size: "L", fullWidth: true, disabled: !role }, formatMessage({ id: "global.finish", defaultMessage: "Finish" }))))), /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(dist.TextButton, { onClick: () => handleSubmit(true) }, formatMessage({
...
const AuthenticatedApp = (0,react.lazy)(
  () => Promise.all(/* import() | Admin-authenticatedApp */[__webpack_require__.e(1734), __webpack_require__.e(801)]).then(__webpack_require__.bind(__webpack_require__, 93858))
);
function App() {
  const toggleNotification = (0,helper_plugin.useNotification)();
  ...
  const appInfo = (0,helper_plugin.useAppInfos)();
  ...
  (0,react.useEffect)(() => {
    const currentToken = helper_plugin.auth.getToken();
    const renewToken = async () => {
      try {
        const {
          data: { token }
        } = await (0,helper_plugin.request)("/admin/renew-token", {
          method: "POST",
          body: { token: currentToken }
        });
        helper_plugin.auth.updateToken(token);
      } catch (err) {
    ...
    const getData = async () => {
      try {
        ...
        updateProjectSettings({
          menuLogo: (0,helper_plugin.prefixFileUrlWithBackendUrl)(menuLogo),
          authLogo: (0,helper_plugin.prefixFileUrlWithBackendUrl)(authLogo)
        });
  ...
  return /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(helper_plugin.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(dist.SkipToContent, null, formatMessage({ id: "skipToContent" })), /* @__PURE__ */ react.createElement(helper_plugin.TrackingProvider, { value: trackingInfo }, /* @__PURE__ */ react.createElement(react_router_dom_min.Switch, null, authRoutes, /* @__PURE__ */ react.createElement(
    react_router_dom_min.Route,
    {
      path: "/auth/:authType",
...
const GuidedTour = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    helper_plugin.GuidedTourProvider,
    {
      guidedTourState,
      currentStep,
      setCurrentStep,
...
const Overlay = (0,styled_components_browser_esm["default"])(dist.Box)`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
...
`;
const Content = (0,styled_components_browser_esm["default"])(dist.Stack)`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
  left: 0;
  padding-top: ${(0,helper_plugin.pxToRem)(160)};
`;
const IconBox = (0,styled_components_browser_esm["default"])(dist.Box)`
  border-radius: 50%;
  svg {
    > path {
...
`;
const LoaderReload = (0,styled_components_browser_esm["default"])(icons_dist.Refresh)`
...
const Blocker = ({ displayedIcon, description, title, isOpen }) => {
  ...
  if (isOpen) {
    return react_dom.createPortal(
      /* @__PURE__ */ react.createElement(Overlay, null, /* @__PURE__ */ react.createElement(Content, { spacing: 6 }, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h1", variant: "alpha" }, formatMessage(title))), /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h2", textColor: "neutral600", fontSize: 4, fontWeight: "regular" }, formatMessage(description)))), /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, displayedIcon === "reload" && /* @__PURE__ */ react.createElement(IconBox, { padding: 6, background: "primary100", borderColor: "primary200" }, /* @__PURE__ */ react.createElement(LoaderReload, { width: (0,helper_plugin.pxToRem)(36), height: (0,helper_plugin.pxToRem)(36) })), displayedIcon === "time" && /* @__PURE__ */ react.createElement(IconBox, { padding: 6, background: "primary100", borderColor: "primary200" }, /* @__PURE__ */ react.createElement(icons_dist.Clock, { width: (0,helper_plugin.pxToRem)(40), height: (0,helper_plugin.pxToRem)(40) }))), /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 2 }, /* @__PURE__ */ react.createElement(Link/* Link */.r, { href: "https://docs.strapi.io", isExternal: true }, formatMessage({
...
const AutoReloadOverlayBlockerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin.AutoReloadOverlayBockerContext.Provider, { value: autoReloadValue }, /* @__PURE__ */ react.createElement(
...
const Notifications = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin.NotificationsProvider, { toggleNotification: displayNotification }, /* @__PURE__ */ react.createElement(
    dist.Stack,
    {
      left: "50%",
      marginLeft: "-250px",
...
const OverlayBlockerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin.OverlayBlockerContext.Provider, { value: { lockApp, unlockApp } }, children, /* @__PURE__ */ react.createElement(Portal, { isOpen }));
};
...
const Theme = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(dist.ThemeProvider, { theme: themes[currentTheme] || themes.light }, children, /* @__PURE__ */ react.createElement(components_GlobalStyle, null));
};
Theme.propTypes = {
  children: (prop_types_default()).element.isRequired
};
...
const Providers = ({
  ...
  return /* @__PURE__ */ react.createElement(components_ThemeToggleProvider, { themes }, /* @__PURE__ */ react.createElement(components_Theme, null, /* @__PURE__ */ react.createElement(react_query_lib.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ react.createElement(react_redux_lib.Provider, { store }, /* @__PURE__ */ react.createElement(contexts/* AdminContext.Provider */.ux.Provider, { value: { getAdminInjectedComponents } }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      helper_plugin.StrapiAppProvider,
      {
        getPlugin,
        menu,
        plugins,
...
class StrapiApp {
  constructor({ adminConfig, appPlugins, library, middlewares, reducers }) {
    ...
    this.configurations = {
      ...
      themes: { light: dist.lightTheme, dark: dist.darkTheme },
      translations: {},
      tutorials: true
    };
  ...
  render() {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      ), /* @__PURE__ */ react.createElement(react_router_dom_min.BrowserRouter, { basename: basename/* default */.Z }, /* @__PURE__ */ react.createElement(pages_App, { store })))
    );
  }
}
    ...
    try {
      const [{ data: components }, { data: contentTypes }] = await Promise.all(
        ["components", "content-types"].map(
          (endPoint) => (0,helper_plugin.request)(`/content-manager/${endPoint}`, { method: "GET" })
        )
      );
      dispatch({
...
const useFetchPermissionsLayout = (id) => {
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      ...
      const { data: data2 } = await (0,helper_plugin.request)("/admin/permissions", {
        method: "GET",
        params: { role: id }
      });
      dispatch({
    ...
    try {
      const [{ data: role }, { data: permissions }] = await Promise.all(
        [`roles/${roleId}`, `roles/${roleId}/permissions`].map(
          (endPoint) => (0,helper_plugin.request)(`/admin/${endPoint}`, { method: "GET" })
        )
      );
      dispatch({
        type: "GET_DATA_SUCCEEDED",
...
const useMenu = () => {
  ...
  const { shouldUpdateStrapi } = (0,helper_plugin.useAppInfos)();
...
const useRolesList = (shouldFetchData = true) => {
  ...
  const fetchRolesList = (0,react.useCallback)(async () => {
    const fetchClient = (0,helper_plugin.getFetchClient)();
    try {
      dispatch({
        type: "GET_DATA"
      });
...
const useSettingsMenu = (noCheck = false) => {
  const { allPermissions: permissions } = (0,helper_plugin.useRBACProvider)();
  const { shouldUpdateStrapi } = (0,helper_plugin.useAppInfos)();
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      const checkPermissions = async (permissionsToCheck, path) => {
        const hasPermission = await (0,helper_plugin.hasPermissions)(permissions, permissionsToCheck);
...
const useSettingsForm = (endPoint, schema, cbSuccess, fieldsToPick) => {
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      try {
        const { data } = await (0,helper_plugin.request)(endPoint, { method: "GET" });
        dispatch({
          type: "GET_DATA_SUCCEEDED",
          data,
          fieldsToPick
  ...
  const handleSubmit = async (e) => {
    ...
    if (!errors) {
      try {
        ...
        const { data } = await (0,helper_plugin.request)(endPoint, {
          method: "PUT",
          body: cleanedData
        });
        cbSuccess(data);
...
const LocaleToggle = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.SimpleMenu, { label: localeNames[locale] }, Object.keys(localeNames).map((lang) => /* @__PURE__ */ react.createElement(dist.MenuItem, { onClick: () => changeLocale(lang), key: lang }, localeNames[lang])));
};
...
const Wrapper = (0,styled_components_browser_esm["default"])(dist.Box)`
  margin: 0 auto;
  width: 552px;
`;
const Column = (0,styled_components_browser_esm["default"])(dist.Flex)`
...
const UnauthenticatedLayout = ({ children }) => {
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(dist.Flex, { as: "header", justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6, paddingRight: 8 }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout_LocaleToggle, null))), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 2, paddingBottom: 11 }, children));
};
...
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28702);
...
const FieldActionWrapper = (0,styled_components__WEBPACK_IMPORTED_MODULE_0__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_1__.FieldAction)`
  svg {
    height: 1rem;
    width: 1rem;
    path {
...
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(41363);
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(28702);
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__);
...
const PasswordInput = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.TextInput)`
  ::-ms-reveal {
    display: none;
  }
`;
const Login = ({ onSubmit, schema, children }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Main, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_3__/* .LayoutContent */ .bU, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    ...
    ({ values, errors, handleChange }) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.Form, { noValidate: true }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_3__/* .Column */ .sg, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_UnauthenticatedLogo__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Box, { paddingTop: 6, paddingBottom: 1 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Typography, { variant: "alpha", as: "h1" }, formatMessage({
      id: "Auth.form.welcome.title",
      defaultMessage: "Welcome!"
    }))), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Box, { paddingBottom: 7 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Typography, { variant: "epsilon", textColor: "neutral600" }, formatMessage({
      id: "Auth.form.welcome.subtitle",
      defaultMessage: "Log in to your Strapi account"
    }))), errors.errorMessage && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      _strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Typography,
      {
        id: "global-form-error",
        role: "alert",
        tabIndex: -1,
      ...
      errors.errorMessage
    )), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Stack, { spacing: 6 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      _strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.TextInput,
      {
        error: errors.email ? formatMessage({
          id: errors.email,
          defaultMessage: "This value is required."
      ...
      PasswordInput,
      {
        ...
        endAction: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
          ...
          passwordShown ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_icons__WEBPACK_IMPORTED_MODULE_9__.Eye, null) : /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_icons__WEBPACK_IMPORTED_MODULE_9__.EyeStriked, null)
        ),
        required: true
      }
    ), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      _strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Checkbox,
      {
        onValueChange: (checked) => {
    ...
    ), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Button, { fullWidth: true, type: "submit" }, formatMessage({ id: "Auth.form.button.login", defaultMessage: "Login" }))))
  ), children), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Flex, { justifyContent: "center" }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__.Box, { paddingTop: 4 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.Link, { to: "/auth/forgot-password" }, formatMessage({
...
Login.propTypes = {
  ...
  schema: prop_types__WEBPACK_IMPORTED_MODULE_10___default().shape({
    type: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().string.isRequired)
  }).isRequired
};
...
const useAuthProviders = ({ ssoEnabled }) => {
  ...
  const fetchAuthProviders = async () => {
    try {
      ...
      const data = await (0,helper_plugin.request)(requestUrl, { method: "GET" });
      dispatch({
        type: "GET_DATA_SUCCEEDED",
        data
      });
...
var useLicenseLimits = __webpack_require__(96510);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(97132);
/* harmony import */ var react_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(75551);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(95489);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _useLicenseLimits__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(96510);
...
const useLicenseLimitNotification = () => {
  const { formatMessage } = (0,react_intl__WEBPACK_IMPORTED_MODULE_4__.useIntl)();
  ...
  const { pathname } = (0,react_router__WEBPACK_IMPORTED_MODULE_5__.useLocation)();
...
/* harmony import */ var react_query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23724);
...
const useLicenseLimits = () => {
  const rbac = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__.useRBAC)(_admin_src_permissions__WEBPACK_IMPORTED_MODULE_1__/* ["default"].settings.users */ .Z.settings.users);
  const {
...
const AuthResponse = () => {
  ...
  const fetchUserInfo = (0,react.useCallback)(async () => {
    try {
      ...
      helper_plugin.auth.clearAppStorage();
      if (jwtToken) {
        helper_plugin.auth.setToken(jwtToken, true);
        const requestUrl = (0,utils/* getRequestUrl */.IF)("users/me");
        const { data } = await (0,helper_plugin.request)(requestUrl, { method: "GET" });
        helper_plugin.auth.setUserInfo(data, true);
...
const DividerFull = (0,styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_6__.Divider)`
  flex: 1;
`;
const Login = (loginProps) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_admin_src_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .ZP, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_admin_src_pages_AuthPage_components_Login_BaseLogin__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, { ...loginProps }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_6__.Box, { paddingTop: 7 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_6__.Stack, { spacing: 7 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_6__.Flex, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(DividerFull, null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_6__.Box, { paddingLeft: 3, paddingRight: 3 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_6__.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "Auth.login.sso.divider" }))), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(DividerFull, null)), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Providers_SSOProviders__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, { providers, displayAllProviders: false })))));
};
Login.defaultProps = {
  onSubmit: (e) => e.preventDefault(),
  requestError: null
...
Login.propTypes = {
  formErrors: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object.isRequired),
  modifiedData: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object.isRequired),
  ...
  requestError: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object)
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Login);
...
`;
const SSOProvidersWrapper = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.Flex)`
...
const SSOProviderButton = ({ provider }) => {
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.Tooltip, { label: provider.displayName }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(SSOButton, { href: `${strapi.backendURL}/admin/connect/${provider.uid}` }, provider.icon ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement("img", { src: provider.icon, "aria-hidden": true, alt: "", height: "32px" }) : /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.Typography, null, provider.displayName)));
};
SSOProviderButton.propTypes = {
  provider: prop_types__WEBPACK_IMPORTED_MODULE_3___default().shape({
    icon: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),
    displayName: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string.isRequired),
    uid: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string.isRequired)
  }).isRequired
};
const SSOProviders = ({ providers, displayAllProviders }) => {
  const { formatMessage } = (0,react_intl__WEBPACK_IMPORTED_MODULE_4__.useIntl)();
  if (displayAllProviders) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.Grid, { gap: 4 }, providers.map((provider) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.GridItem, { key: provider.uid, col: 4 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(SSOProviderButton, { provider }))));
  }
  if (providers.length > 2 && !displayAllProviders) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.Grid, { gap: 4 }, providers.slice(0, 2).map((provider) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.GridItem, { key: provider.uid, col: 4 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(SSOProviderButton, { provider }))), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.GridItem, { col: 4 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      _strapi_design_system__WEBPACK_IMPORTED_MODULE_2__.Tooltip,
      {
        label: formatMessage({
          id: "global.see-more"
        })
      },
      /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(SSOButton, { as: react_router_dom__WEBPACK_IMPORTED_MODULE_5__.Link, to: "/auth/providers" }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { "aria-hidden": true }, "\u2022\u2022\u2022"))
    )));
  }
...
SSOProviders.propTypes = {
  providers: prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_3___default().object)).isRequired,
  displayAllProviders: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool)
};
...
const DividerFull = (0,styled_components_browser_esm["default"])(dist.Divider)`
  flex: 1;
`;
const Providers = () => {
  const ssoEnabled = strapi.features.isEnabled(strapi.features.SSO);
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* Column */.sg, null, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 6, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h1", variant: "alpha" }, formatMessage({ id: "Auth.form.welcome.title" }))), /* @__PURE__ */ react.createElement(dist.Box, { paddingBottom: 7 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "epsilon", textColor: "neutral600" }, formatMessage({ id: "Auth.login.sso.subtitle" })))), /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 7 }, isLoading ? /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Loader, null, formatMessage({ id: "Auth.login.sso.loading" }))) : /* @__PURE__ */ react.createElement(SSOProviders/* default */.Z, { providers }), /* @__PURE__ */ react.createElement(dist.Flex, null, /* @__PURE__ */ react.createElement(DividerFull, null), /* @__PURE__ */ react.createElement(dist.Box, { paddingLeft: 3, paddingRight: 3 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "or" }))), /* @__PURE__ */ react.createElement(DividerFull, null)), /* @__PURE__ */ react.createElement(dist.Button, { fullWidth: true, size: "L", onClick: handleClick }, formatMessage({ id: "Auth.form.button.login.strapi" })))), /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Box, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(helper_plugin.Link, { to: "/auth/forgot-password" }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "pi" }, formatMessage({ id: "Auth.link.forgot-password" })))))));
};
/* harmony default export */ const components_Providers = (Providers);
