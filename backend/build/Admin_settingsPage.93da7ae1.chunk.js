...
const FromComputerForm = ({ setLocalImage, goTo, next, onClose }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement("form", null, /* @__PURE__ */ react.createElement(dist.Box, { paddingLeft: 8, paddingRight: 8, paddingTop: 6, paddingBottom: 6 }, /* @__PURE__ */ react.createElement(dist.Field, { name: "logo-upload", error: fileError }, /* @__PURE__ */ react.createElement("label", { htmlFor: "logo-upload" }, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(
    dist.Flex,
    {
      paddingTop: 9,
      paddingBottom: 7,
...
var SubNavHeader = __webpack_require__(74012);
...
var IS_DISABLED=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(53273)/* ["default"] */ .Z);}return (__webpack_require__(79578)/* ["default"] */ .Z);}();var ActionRow=function ActionRow(_ref){var arrayOfOptionsGroupedByCategory=_ref.arrayOfOptionsGroupedByCategory,isFormDisabled=_ref.isFormDisabled,isGrey=_ref.isGrey,label=_ref.label,name=_ref.name,onChange=_ref.onChange,value=_ref.value;var _useIntl=(0,react_intl.useIntl)(),formatMessage=_useIntl.formatMessage;var handleChange=function handleChange(val){onChange(name,getNewStateFromChangedValues(arrayOfOptionsGroupedByCategory,val));};return/*#__PURE__*/react.createElement(dist.Flex,{as:"li",background:isGrey?'neutral100':'neutral0',paddingBottom:3,paddingTop:3},/*#__PURE__*/react.createElement(dist.Flex,{paddingLeft:6,style:{width:180}},/*#__PURE__*/react.createElement(dist.Typography,{variant:"sigma",textColor:"neutral600"},formatMessage({id:'Settings.permissions.conditions.can',defaultMessage:'Can'}),"\xA0"),/*#__PURE__*/react.createElement(dist.Typography,{variant:"sigma",title:label,textColor:"primary600",ellipsis:true},formatMessage({id:"Settings.roles.form.permissions.".concat(label.toLowerCase()),defaultMessage:label})),/*#__PURE__*/react.createElement(dist.Typography,{variant:"sigma",textColor:"neutral600"},"\xA0",formatMessage({id:'Settings.permissions.conditions.when',defaultMessage:'When'}))),/*#__PURE__*/react.createElement(dist.Box,{style:{maxWidth:430,width:'100%'}},/*#__PURE__*/react.createElement(dist.MultiSelectNested,{id:name,customizeContent:function customizeContent(values){return"".concat(values.length," currently selected");},onChange:handleChange,value:getSelectedValues(value),options:getNestedOptions(arrayOfOptionsGroupedByCategory),disabled:isFormDisabled||IS_DISABLED})));};ActionRow.propTypes={arrayOfOptionsGroupedByCategory:(prop_types_default()).array.isRequired,isFormDisabled:(prop_types_default()).bool.isRequired,isGrey:(prop_types_default()).bool.isRequired,label:(prop_types_default()).string.isRequired,name:(prop_types_default()).string.isRequired,value:(prop_types_default()).object.isRequired,onChange:(prop_types_default()).func.isRequired};/* harmony default export */ const ConditionsModal_ActionRow = (ActionRow);
...
var SubActionRow_IS_DISABLED=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(76766)/* ["default"] */ .Z);}return (__webpack_require__(53558)/* ["default"] */ .Z);}();var SubActionRow_Cell=/*#__PURE__*/(0,styled_components_browser_esm["default"])(dist.Flex).withConfig({displayName:"SubActionRow__Cell",componentId:"sc-7y8yzq-0"})(["width:",";position:relative;"],cellWidth);var RowWrapper=/*#__PURE__*/(0,styled_components_browser_esm["default"])(dist.Flex).withConfig({displayName:"SubActionRow__RowWrapper",componentId:"sc-7y8yzq-1"})(["height:",";"],rowHeight);var SubActionRow_Wrapper=/*#__PURE__*/(0,styled_components_browser_esm["default"])(dist.Box).withConfig({displayName:"SubActionRow__Wrapper",componentId:"sc-7y8yzq-2"})(["padding-left:","rem;"],31/16);var LeftBorderTimeline=/*#__PURE__*/(0,styled_components_browser_esm["default"])(dist.Box).withConfig({displayName:"SubActionRow__LeftBorderTimeline",componentId:"sc-7y8yzq-3"})(["border-left:",";"],function(_ref){var isVisible=_ref.isVisible,theme=_ref.theme;return isVisible?"4px solid ".concat(theme.colors.primary200):'4px solid transparent';});var RowStyle=/*#__PURE__*/(0,styled_components_browser_esm["default"])(dist.Flex).withConfig({displayName:"SubActionRow__RowStyle",componentId:"sc-7y8yzq-4"})(["padding-left:",";width:","px;"," ",";"],function(_ref2){var theme=_ref2.theme;return theme.spaces[4];},function(_ref3){var level=_ref3.level;return 145-level*36;},function(_ref4){var isCollapsable=_ref4.isCollapsable,theme=_ref4.theme;return isCollapsable&&"\n      ".concat(CollapsePropertyMatrix_CarretIcon," {\n        display: block;\n        color: ").concat(theme.colors.neutral100,";\n      }\n      &:hover {\n        ").concat(utils_activeStyle(theme),"\n      }\n  ");},function(_ref5){var isActive=_ref5.isActive,theme=_ref5.theme;return isActive&&utils_activeStyle(theme);});var TopTimeline=/*#__PURE__*/styled_components_browser_esm["default"].div.withConfig({displayName:"SubActionRow__TopTimeline",componentId:"sc-7y8yzq-5"})(["padding-top:",";margin-top:",";width:","rem;background-color:",";border-top-left-radius:2px;border-top-right-radius:2px;"],function(_ref6){var theme=_ref6.theme;return theme.spaces[2];},function(_ref7){var theme=_ref7.theme;return theme.spaces[2];},4/16,function(_ref8){var theme=_ref8.theme;return theme.colors.primary200;});var SubActionRow=function SubActionRow(_ref9){var childrenForm=_ref9.childrenForm,isFormDisabled=_ref9.isFormDisabled,recursiveLevel=_ref9.recursiveLevel,pathToDataFromActionRow=_ref9.pathToDataFromActionRow,propertyActions=_ref9.propertyActions,parentName=_ref9.parentName,propertyName=_ref9.propertyName;var _useIntl=(0,react_intl.useIntl)(),formatMessage=_useIntl.formatMessage;var _usePermissionsDataMa=(0,hooks/* usePermissionsDataManager */.$_)(),modifiedData=_usePermissionsDataMa.modifiedData,onChangeParentCheckbox=_usePermissionsDataMa.onChangeParentCheckbox,onChangeSimpleCheckbox=_usePermissionsDataMa.onChangeSimpleCheckbox;var _useState=(0,react.useState)(null),_useState2=(0,slicedToArray/* default */.Z)(_useState,2),rowToOpen=_useState2[0],setRowToOpen=_useState2[1];var handleClickToggleSubLevel=function handleClickToggleSubLevel(name){setRowToOpen(function(prev){if(prev===name){return null;}return name;});};var displayedRecursiveChildren=(0,react.useMemo)(function(){if(!rowToOpen){return null;}return childrenForm.find(function(_ref10){var value=_ref10.value;return value===rowToOpen;});},[rowToOpen,childrenForm]);return/*#__PURE__*/react.createElement(SubActionRow_Wrapper,null,/*#__PURE__*/react.createElement(TopTimeline,null),childrenForm.map(function(_ref11,index){var label=_ref11.label,value=_ref11.value,required=_ref11.required,subChildrenForm=_ref11.children;var isVisible=index+1<childrenForm.length;var isArrayType=Array.isArray(subChildrenForm);var isActive=rowToOpen===value;return/*#__PURE__*/react.createElement(LeftBorderTimeline,{key:value,isVisible:isVisible},/*#__PURE__*/react.createElement(RowWrapper,null,/*#__PURE__*/react.createElement(components_Curve,{color:"primary200"}),/*#__PURE__*/react.createElement(dist.Flex,{style:{flex:1}},/*#__PURE__*/react.createElement(RowStyle,{level:recursiveLevel,isActive:isActive,isCollapsable:isArrayType},/*#__PURE__*/react.createElement(components_CollapseLabel,(0,esm_extends/* default */.Z)({alignItems:"center",isCollapsable:isArrayType},isArrayType&&{onClick:function onClick(){return handleClickToggleSubLevel(value);},'aria-expanded':isActive,onKeyDown:function onKeyDown(_ref12){var key=_ref12.key;return(key==='Enter'||key===' ')&&handleClickToggleSubLevel(value);},tabIndex:0,role:'button'},{title:label}),/*#__PURE__*/react.createElement(dist.Typography,{ellipsis:true},upperFirst_default()(label)),required&&/*#__PURE__*/react.createElement(components_RequiredSign,null),/*#__PURE__*/react.createElement(CollapsePropertyMatrix_CarretIcon,{$isActive:isActive}))),/*#__PURE__*/react.createElement(dist.Flex,{style:{flex:1}},propertyActions.map(function(_ref13){var actionId=_ref13.actionId,propertyLabel=_ref13.label,isActionRelatedToCurrentProperty=_ref13.isActionRelatedToCurrentProperty;if(!isActionRelatedToCurrentProperty){return/*#__PURE__*/react.createElement(components_HiddenAction,{key:actionId});}/*
                       ...
                       */var checkboxName=[].concat((0,toConsumableArray/* default */.Z)(pathToDataFromActionRow.split('..')),[actionId,'properties',propertyName],(0,toConsumableArray/* default */.Z)(parentName.split('..')),[value]);var checkboxValue=get_default()(modifiedData,checkboxName,false);if(!subChildrenForm){return/*#__PURE__*/react.createElement(SubActionRow_Cell,{key:propertyLabel,justifyContent:"center",alignItems:"center"},/*#__PURE__*/react.createElement(dist.BaseCheckbox,{disabled:isFormDisabled||SubActionRow_IS_DISABLED,name:checkboxName.join('..'),"aria-label":formatMessage({id:"Settings.permissions.select-by-permission",defaultMessage:'Select {label} permission'},{label:"".concat(parentName," ").concat(label," ").concat(propertyLabel)})// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:function onValueChange(value){onChangeSimpleCheckbox({target:{name:checkboxName.join('..'),value:value}});},value:checkboxValue}));}var _getCheckboxState=utils_getCheckboxState(checkboxValue),hasAllActionsSelected=_getCheckboxState.hasAllActionsSelected,hasSomeActionsSelected=_getCheckboxState.hasSomeActionsSelected;return/*#__PURE__*/react.createElement(SubActionRow_Cell,{key:propertyLabel,justifyContent:"center",alignItems:"center"},/*#__PURE__*/react.createElement(dist.BaseCheckbox,{key:propertyLabel,disabled:isFormDisabled||SubActionRow_IS_DISABLED,name:checkboxName.join('..'),"aria-label":formatMessage({id:"Settings.permissions.select-by-permission",defaultMessage:'Select {label} permission'},{label:"".concat(parentName," ").concat(label," ").concat(propertyLabel)})// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:function onValueChange(value){onChangeParentCheckbox({target:{name:checkboxName.join('..'),value:value}});},value:hasAllActionsSelected,indeterminate:hasSomeActionsSelected}));})))),displayedRecursiveChildren&&isActive&&/*#__PURE__*/react.createElement(dist.Box,{paddingBottom:2},/*#__PURE__*/react.createElement(SubActionRow,{isFormDisabled:isFormDisabled,parentName:"".concat(parentName,"..").concat(value),pathToDataFromActionRow:pathToDataFromActionRow,propertyActions:propertyActions,propertyName:propertyName,recursiveLevel:recursiveLevel+1,childrenForm:displayedRecursiveChildren.children})));}));};SubActionRow.propTypes={childrenForm:(prop_types_default()).array.isRequired,isFormDisabled:(prop_types_default()).bool.isRequired,parentName:(prop_types_default()).string.isRequired,pathToDataFromActionRow:(prop_types_default()).string.isRequired,propertyActions:(prop_types_default()).array.isRequired,propertyName:(prop_types_default()).string.isRequired,recursiveLevel:(prop_types_default()).number.isRequired};/* harmony default export */ const CollapsePropertyMatrix_SubActionRow = (/*#__PURE__*/(0,react.memo)(SubActionRow));
...
var GlobalActions_IS_DISABLED=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(85822)/* ["default"] */ .Z);}return (__webpack_require__(99047)/* ["default"] */ .Z);}();var CenteredStack=/*#__PURE__*/(0,styled_components_browser_esm["default"])(dist.Stack).withConfig({displayName:"GlobalActions__CenteredStack",componentId:"sc-1vxwsjr-0"})(["align-items:center;justify-content:center;width:",";flex-shrink:0;"],cellWidth);var GlobalActions=function GlobalActions(_ref){var actions=_ref.actions,isFormDisabled=_ref.isFormDisabled,kind=_ref.kind;var _useIntl=(0,react_intl.useIntl)(),formatMessage=_useIntl.formatMessage;var _usePermissionsDataMa=(0,hooks/* usePermissionsDataManager */.$_)(),modifiedData=_usePermissionsDataMa.modifiedData,onChangeCollectionTypeGlobalActionCheckbox=_usePermissionsDataMa.onChangeCollectionTypeGlobalActionCheckbox;var displayedActions=(0,react.useMemo)(function(){return utils_findDisplayedActions(actions);},[actions]);var checkboxesState=(0,react.useMemo)(function(){return getRowLabelCheckboxesState(displayedActions,modifiedData[kind]);},[modifiedData,displayedActions,kind]);return/*#__PURE__*/react.createElement(dist.Box,{paddingBottom:4,paddingTop:6,style:{paddingLeft:firstRowWidth}},/*#__PURE__*/react.createElement(dist.Stack,{horizontal:true,spacing:0},displayedActions.map(function(_ref2){var label=_ref2.label,actionId=_ref2.actionId;return/*#__PURE__*/react.createElement(CenteredStack,{key:actionId,spacing:3},/*#__PURE__*/react.createElement(dist.Typography,{variant:"sigma",textColor:"neutral500"},formatMessage({id:"Settings.roles.form.permissions.".concat(label.toLowerCase()),defaultMessage:label})),/*#__PURE__*/react.createElement(dist.BaseCheckbox,{disabled:isFormDisabled||GlobalActions_IS_DISABLED,onValueChange:function onValueChange(value){onChangeCollectionTypeGlobalActionCheckbox(kind,actionId,value);},name:actionId,"aria-label":formatMessage({id:"Settings.permissions.select-all-by-permission",defaultMessage:'Select all {label} permissions'},{label:formatMessage({id:"Settings.roles.form.permissions.".concat(label.toLowerCase()),defaultMessage:label})}),value:get_default()(checkboxesState,[actionId,'hasAllActionsSelected'],false),indeterminate:get_default()(checkboxesState,[actionId,'hasSomeActionsSelected'],false)}));})));};GlobalActions.defaultProps={actions:[]};GlobalActions.propTypes={actions:prop_types_default().arrayOf(prop_types_default().shape({label:(prop_types_default()).string.isRequired,actionId:(prop_types_default()).string.isRequired,subjects:(prop_types_default()).array.isRequired})),isFormDisabled:(prop_types_default()).bool.isRequired,kind:(prop_types_default()).string.isRequired};/* harmony default export */ const components_GlobalActions = (/*#__PURE__*/(0,react.memo)(GlobalActions));
...
var formattedActions=utils_formatActions(actions,modifiedData,pathToData);var doesButtonHasCondition=utils_getConditionsButtonState(get_default()(modifiedData,(0,toConsumableArray/* default */.Z)(pathToData),{}));return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(dist.Box,null,/*#__PURE__*/react.createElement(dist.Flex,{justifyContent:"space-between",alignItems:"center"},/*#__PURE__*/react.createElement(dist.Box,{paddingRight:4},/*#__PURE__*/react.createElement(dist.Typography,{variant:"sigma",textColor:"neutral600"},subCategoryName)),/*#__PURE__*/react.createElement(Border,null),/*#__PURE__*/react.createElement(dist.Box,{paddingLeft:4},/*#__PURE__*/react.createElement(dist.Checkbox,{name:pathToData.join('..'),disabled:isFormDisabled||SubCategory_IS_DISABLED// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:function onValueChange(value){onChangeParentCheckbox({target:{name:pathToData.join('..'),value:value}});},indeterminate:hasSomeActionsSelected,value:hasAllActionsSelected},formatMessage({id:'app.utils.select-all',defaultMessage:'Select all'})))),/*#__PURE__*/react.createElement(dist.Flex,{paddingTop:6,paddingBottom:6},/*#__PURE__*/react.createElement(dist.Grid,{gap:2,style:{flex:1}},formattedActions.map(function(_ref4){var checkboxName=_ref4.checkboxName,value=_ref4.value,action=_ref4.action,displayName=_ref4.displayName,hasConditions=_ref4.hasConditions;return/*#__PURE__*/react.createElement(dist.GridItem,{col:3,key:action},/*#__PURE__*/react.createElement(CheckboxWrapper,{disabled:isFormDisabled||SubCategory_IS_DISABLED,hasConditions:hasConditions},/*#__PURE__*/react.createElement(dist.Checkbox,{name:checkboxName,disabled:isFormDisabled||SubCategory_IS_DISABLED// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
...
const RoleRow = ({ id, name, description, usersCount, icons, rowIndex }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    _strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Tr,
    {
    ...
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Td, { maxWidth: (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.pxToRem)(130) }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Typography, { ellipsis: true, textColor: "neutral800" }, name)),
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Td, { maxWidth: (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.pxToRem)(250) }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Typography, { ellipsis: true, textColor: "neutral800" }, description)),
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Td, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Typography, { textColor: "neutral800" }, usersCountText)),
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Td, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Flex, { justifyContent: "flex-end", ..._strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.stopPropagation }, icons.map(
      (icon, i) => icon ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.Box, { key: icon.label, paddingLeft: i === 0 ? 0 : 1 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__.IconButton, { onClick: icon.onClick, label: icon.label, noBorder: true, icon: icon.icon })) : null
    )))
  );
};
RoleRow.propTypes = {
  ...
  usersCount: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number.isRequired),
  icons: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().array.isRequired),
  rowIndex: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number.isRequired)
};
...
const UpgradeWrapper = styled_components_browser_esm["default"].div`
  ...
  z-index: 3;
  inset: 0;
  background: ${({ theme }) => (0,helper_plugin.setHexOpacity)(theme.colors.neutral800, 0.2)};
  padding: 0 ${({ theme }) => theme.spaces[8]};
`;
const UpgradeContainer = (0,styled_components_browser_esm["default"])(design_system_dist.Flex)`
  position: relative;
...
`;
const StackFlexStart = (0,styled_components_browser_esm["default"])(design_system_dist.Stack)`
  align-items: flex-start;
  max-width: ${400 / 16}rem;
  z-index: 0;
`;
const CloseButtonContainer = (0,styled_components_browser_esm["default"])(design_system_dist.Box)`
  position: absolute;
  right: ${({ theme }) => theme.spaces[4]};
  top: ${({ theme }) => theme.spaces[4]};
`;
const UpgradePlanModal = ({ onClose, isOpen }) => {
  (0,helper_plugin.useLockScroll)(isOpen);
  const { formatMessage } = (0,react_intl.useIntl)();
  if (!isOpen) {
    return null;
  }
  return /* @__PURE__ */ react.createElement(design_system_dist.Portal, null, /* @__PURE__ */ react.createElement(UpgradeWrapper, { onClick: onClose }, /* @__PURE__ */ react.createElement(design_system_dist.FocusTrap, { onEscape: onClose }, /* @__PURE__ */ react.createElement(
    UpgradeContainer,
    {
    ...
    /* @__PURE__ */ react.createElement(CloseButtonContainer, null, /* @__PURE__ */ react.createElement(design_system_dist.IconButton, { onClick: onClose, "aria-label": "Close", icon: /* @__PURE__ */ react.createElement(dist.Cross, null) })),
    /* @__PURE__ */ react.createElement(StackFlexStart, { spacing: 6 }, /* @__PURE__ */ react.createElement(design_system_dist.Typography, { fontWeight: "bold", textColor: "primary600" }, formatMessage({
      id: "app.components.UpgradePlanModal.text-ce",
      defaultMessage: "COMMUNITY EDITION"
    })), /* @__PURE__ */ react.createElement(design_system_dist.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(design_system_dist.Typography, { variant: "alpha", as: "h2", id: "upgrade-plan" }, formatMessage({
      ...
      LinkButton/* LinkButton */.Q,
      {
        ...
        isExternal: true,
        endIcon: /* @__PURE__ */ react.createElement(dist.ExternalLink, null)
      },
      formatMessage({
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(design_system_dist.Main, null, /* @__PURE__ */ react.createElement(helper_plugin.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    {
      primaryAction: /* @__PURE__ */ react.createElement(design_system_dist.Button, { onClick: handleToggleModalForCreatingRole, startIcon: /* @__PURE__ */ react.createElement(dist.Plus, null), size: "S" }, formatMessage({
    ...
    design_system_dist.Table,
    {
      colCount,
      rowCount,
      footer: /* @__PURE__ */ react.createElement(design_system_dist.TFooter, { onClick: handleToggleModalForCreatingRole, icon: /* @__PURE__ */ react.createElement(dist.Plus, null) }, formatMessage({
        id: "Settings.roles.list.button.add",
        defaultMessage: "Add new role"
      }))
    },
    /* @__PURE__ */ react.createElement(design_system_dist.Thead, null, /* @__PURE__ */ react.createElement(design_system_dist.Tr, null, /* @__PURE__ */ react.createElement(design_system_dist.Th, null, /* @__PURE__ */ react.createElement(design_system_dist.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({
      id: "global.name",
      defaultMessage: "Name"
    ...
    /* @__PURE__ */ react.createElement(design_system_dist.Tbody, null, sortedRoles?.map((role, rowIndex) => /* @__PURE__ */ react.createElement(
      RoleRow/* default */.Z,
      {
        key: role.id,
        id: role.id,
...
const AdminSeatInfo = () => {
  ...
  })), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_4__.Stack, { spacing: 2, horizontal: true }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_4__.Flex, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_4__.Typography, { as: "p" }, formatMessage(
    {
...
const CreatePage = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(helper_plugin.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ), /* @__PURE__ */ react.createElement(dist.ContentLayout, null, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(dist.Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(dist.Box, null, /* @__PURE__ */ react.createElement(dist.Box, null, /* @__PURE__ */ react.createElement(dist.Typography, { fontWeight: "bold" }, formatMessage({
      id: "global.details",
