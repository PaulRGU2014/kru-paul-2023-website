"use strict";
(self["webpackChunkproject_kru_2023"] = self["webpackChunkproject_kru_2023"] || []).push([[2544],{
...
const EditPage = () => {
  ...
  const handleEditRoleSubmit = async (data) => {
    try {
      ...
      await (0,build.request)(`/admin/roles/${id}`, {
        method: "PUT",
        body: data
      });
      if (role.code !== "strapi-super-admin") {
        await (0,build.request)(`/admin/roles/${id}/permissions`, {
          method: "PUT",
          body: {
