(self["webpackChunkproject_kru_2023"] = self["webpackChunkproject_kru_2023"] || []).push([[8880],{
...
const AttributeIcon = ({ type, customField, ...rest }) => {
  ...
  return /* @__PURE__ */ react.createElement(IconBox, { as: Compo, ...rest, "aria-hidden": true });
};
...
const L = (0,styled_components_browser_esm["default"])(BaseButton/* BaseButtonWrapper */.G)`
...
`, l = react.forwardRef(
  ({ variant: e, startIcon: o, endIcon: f, disabled: i, children: s, size: m, href: n, to: p, ...u }, v) => {
    ...
    return /* @__PURE__ */ react.createElement(L, {
      ref: v,
      "aria-disabled": i,
      size: m,
      variant: e,
      ...
      href: i ? "#" : n,
      ...u,
      as: p && !i ? react_router_dom_min.NavLink : "a"
    }, o && /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      "aria-hidden": !0,
      paddingRight: 2
    }, o), m === "S" ? /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
      variant: "pi",
      fontWeight: "bold"
    }, s) : /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
      fontWeight: "bold"
    }, s), f && /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      "aria-hidden": !0,
      paddingLeft: 2
    }, f));
  }
...
const EmptyAttributes = () => {
  ...
  }))))), /* @__PURE__ */ react.createElement(l, { to: "/marketplace", variant: "secondary", startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null) }, formatMessage({
...
// EXTERNAL MODULE: ./node_modules/@internationalized/number/dist/main.js
var main = __webpack_require__(99216);
...
;// CONCATENATED MODULE: ./node_modules/@strapi/design-system/dist/helpers/getDefaultLocale.js
...
var react_use_callback_ref_dist = __webpack_require__(98402);
;// CONCATENATED MODULE: ./node_modules/@strapi/design-system/dist/hooks/useControllableState.js


function useControllableState_R({ prop: n, defaultProp: u, onChange: c = () => {
} }) {
  const [t, e] = m({ defaultProp: u, onChange: c }), o = n !== void 0, l = typeof n == "function" ? n(t) : n, d = o ? l : t, f = (0,react_use_callback_ref_dist.useCallbackRef)(c), C = react.useCallback((s) => {
    if (o) {
...
function m({ defaultProp: n, onChange: u }) {
  const c = react.useState(n), [t] = c, e = react.useRef(t), o = (0,react_use_callback_ref_dist.useCallbackRef)(u);
...
const h = styled_components_browser_esm["default"].button`
  display: flex;
  height: 1rem;
...
`, J = "", c = react.forwardRef(
  ({
    ...
    const O = (0,useId/* useId */.M)("numberinput", D), p = x || e(), m = (0,react.useRef)(new main.NumberParser(p, { style: "decimal" })), u = (0,react.useRef)(new main.NumberFormatter(p, { maximumFractionDigits: 20 })), [a, S] = useControllableState_R({
      prop(e) {
        const o = String(k);
    ...
    return /* @__PURE__ */ react.createElement(Field/* Field */.g, {
      ...
      action: V
    }, d), /* @__PURE__ */ react.createElement(FieldInput/* FieldInput */._, {
      ref: R,
      startAction: w,
      disabled: s,
      type: "text",
      ...
      value: a,
      size: n,
      endAction: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(h, {
        disabled: s,
        "aria-hidden": !0,
        reverse: !0,
        onClick: f,
...
c.propTypes = {
  ...
  startAction: prop_types.element,
...
`, v = styled_components_browser_esm["default"].button`
  border: none;
  padding: 0;
...
`, SubNavLinkSection_l = ({ label: t, children: p, id: s }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(k, {
    ...
    rotated: r
  }, /* @__PURE__ */ react.createElement(icons_dist.CarretDown, {
    "aria-hidden": !0
...
SubNavLinkSection_l.defaultProps = {
  id: void 0
};
SubNavLinkSection_l.propTypes = {
  children: prop_types.node.isRequired,
  id: prop_types.string,
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(SubNavSections/* SubNavSections */.Z, null, menu.map((section) => /* @__PURE__ */ react.createElement(react.Fragment, { key: section.name }, /* @__PURE__ */ react.createElement(
      ...
      section.links.map((link) => {
        if (link.links) {
          return /* @__PURE__ */ react.createElement(SubNavLinkSection_l, { key: link.name, label: upperFirst_default()(link.title) }, link.links.map((subLink) => /* @__PURE__ */ react.createElement(
...
const App = () => {
  ...
  return /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default.main */.Z.main }, /* @__PURE__ */ react.createElement(Helmet.Helmet, { title }), /* @__PURE__ */ react.createElement(components_FormModalNavigationProvider, null, /* @__PURE__ */ react.createElement(components_DataManagerProvider, null, /* @__PURE__ */ react.createElement(Layout/* Layout */.A, { sideNav: /* @__PURE__ */ react.createElement(components_ContentTypeBuilderNav, null) }, /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(react_router_dom_min.Switch, null, /* @__PURE__ */ react.createElement(
