(self["webpackChunkproject_kru_2023"] = self["webpackChunkproject_kru_2023"] || []).push([[994],{
...
const CardPreview = ({ labelField, transparent, isSibling }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 3 }, /* @__PURE__ */ react.createElement(DragButton, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Drag/* default */.Z, null)), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, cardEllipsisTitle)),
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { paddingLeft: 3 }, /* @__PURE__ */ react.createElement(ActionBox, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Pencil/* default */.Z, null)), /* @__PURE__ */ react.createElement(ActionBox, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Cross["default"], null)))
  );
};
...
const StackWrapper = (0,styled_components_browser_esm["default"])(dist.Stack)`
  width: 100%;
...
const RelationItem = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    isDragging ? /* @__PURE__ */ react.createElement(RelationItemPlaceholder, null) : /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(StackWrapper, { spacing: 1, horizontal: true }, canDrag ? /* @__PURE__ */ react.createElement(
        dist.IconButton,
        {
          forwardedAs: "div",
          role: "button",
...
const Relation = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { basis: size <= 6 ? "100%" : "70%", spacing: 1, ...props }, search),
    loadMore
  ), children);
};
  ...
  const getData = (0,react.useCallback)(
    async (uid, source) => {
      ...
      try {
        ...
        const {
          data: { data }
        } = await utils/* axiosInstance.get */.be.get(endPoint, { cancelToken: source.token });
        dispatch({
...
const LinkEllipsis = (0,styled_components_browser_esm["default"])(Link/* Link */.r)`
  display: block;
...
const RelationInput = ({
  ...
  const shouldDisplayLoadMoreButton = !!labelLoadMore && paginatedRelations.hasNextPage || paginatedRelations.isLoading;
...
const RelationDragPreview = ({ status, displayedValue, width }) => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Box, { style: { width } }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(StackWrapper, { spacing: 1, horizontal: true }, /* @__PURE__ */ react.createElement(dist.IconButton, { noBorder: true }, /* @__PURE__ */ react.createElement(icons_dist.Drag, null)), /* @__PURE__ */ react.createElement(ChildrenWrapper, { maxWidth: "100%", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(dist.Box, { minWidth: 0, paddingTop: 1, paddingBottom: 1, paddingRight: 4 }, /* @__PURE__ */ react.createElement(LinkEllipsis, null, /* @__PURE__ */ react.createElement(dist.Typography, { textColor: "primary600", ellipsis: true }, displayedValue))), status && /* @__PURE__ */ react.createElement(dist.Status, { variant: statusColor, showBullet: false, size: "S" }, /* @__PURE__ */ react.createElement(dist.Typography, { fontWeight: "bold", textColor: `${statusColor}700` }, stateMessage[status])))),
...
const ComponentInitializer = ({ error, isReadOnly, onClick }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center", style: { cursor: isReadOnly ? "not-allowed" : "inherit" } }, /* @__PURE__ */ react.createElement(IconWrapper, null, /* @__PURE__ */ react.createElement(PlusCircle/* default */.Z, null))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "primary600", variant: "pi", fontWeight: "bold" }, formatMessage({
...
const EditorLayout = ({ children, isExpandMode, error, previewContent, onCollapse }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  (0,build.useLockScroll)(isExpandMode);
  if (isExpandMode) {
...
const Wysiwyg_Wysiwyg = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1 }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", fontWeight: "bold", textColor: "neutral800" }, label, required && /* @__PURE__ */ react.createElement(TypographyAsterisk, { textColor: "danger600" }, "*")), labelAction && /* @__PURE__ */ react.createElement(Wysiwyg_LabelAction, { paddingLeft: 1 }, labelAction)), /* @__PURE__ */ react.createElement(
    EditorLayout,
    {
      isExpandMode,
      error,
...
const EditorWrapper = styled_components_browser_esm["default"].div`
  cursor: ${({ disabled }) => disabled ? "not-allowed !important" : "auto"};
  /* BASICS */
...
const Label_Label = ({ intlLabel, labelAction, name }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  const label = intlLabel?.id ? formatMessage(
    { id: intlLabel.id, defaultMessage: intlLabel.defaultMessage },
    { ...intlLabel.values }
  ) : name;
  return /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.Q, { action: labelAction }, label);
};
...
/* harmony default export */ const InputJSON_Label = (Label_Label);
...
const InputJSON_loadCss = async () => {
  await __webpack_require__.e(/* import() | codemirror-javacript */ 3860).then(__webpack_require__.t.bind(__webpack_require__, 96876, 23));
  await __webpack_require__.e(/* import() | codemirror-addon-lint */ 2781).then(__webpack_require__.t.bind(__webpack_require__, 3256, 23));
  await __webpack_require__.e(/* import() | codemirror-addon-lint-js */ 953).then(__webpack_require__.t.bind(__webpack_require__, 96477, 23));
  await __webpack_require__.e(/* import() | codemirror-addon-closebrackets */ 5178).then(__webpack_require__.t.bind(__webpack_require__, 82801, 23));
  await __webpack_require__.e(/* import() | codemirror-addon-mark-selection */ 5509).then(__webpack_require__.t.bind(__webpack_require__, 64020, 23));
  await __webpack_require__.e(/* import() | codemirror-css */ 3973).then(__webpack_require__.bind(__webpack_require__, 91380));
  await __webpack_require__.e(/* import() | codemirror-theme */ 2218).then(__webpack_require__.bind(__webpack_require__, 69039));
};
InputJSON_loadCss();
class InputJSON extends react.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1 }, /* @__PURE__ */ react.createElement(
        InputJSON_Label,
        {
      ...
      ), /* @__PURE__ */ react.createElement(StyledBox, { error: this.props.error }, /* @__PURE__ */ react.createElement(EditorWrapper, { disabled: this.props.disabled }, /* @__PURE__ */ react.createElement(
        "textarea",
        {
          ref: this.editor,
          autoComplete: "off",
...
const EndActionWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  position: relative;
`;
...
const InputUID = ({
  ...
  generateUid.current = async (shouldSetInitialValue = false) => {
    ...
    try {
      const {
        data: { data }
      } = await utils/* axiosInstance.post */.be.post(requestURL, {
        contentTypeUID,
        field: name,
        data: modifiedData
      });
  ...
  const checkAvailability = async () => {
    ...
    try {
      const { data } = await utils/* axiosInstance.post */.be.post(requestURL, {
        contentTypeUID,
        field: name,
  ...
  return /* @__PURE__ */ react.createElement(
    TextInput/* TextInput */.o,
    {
      disabled,
      error,
      endAction: /* @__PURE__ */ react.createElement(EndActionWrapper, null, availability && availability.isAvailable && !regenerateLabel && /* @__PURE__ */ react.createElement(TextValidation, { alignItems: "center", justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(CheckCircle/* default */.Z, null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "success600", variant: "pi" }, formatMessage({
        id: "content-manager.components.uid.available",
        defaultMessage: "Available"
      }))), availability && !availability.isAvailable && !regenerateLabel && /* @__PURE__ */ react.createElement(TextValidation, { notAvailable: true, alignItems: "center", justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "danger600", variant: "pi" }, formatMessage({
        id: "content-manager.components.uid.unavailable",
        defaultMessage: "Unavailable"
      }))), regenerateLabel && /* @__PURE__ */ react.createElement(TextValidation, { alignItems: "center", justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "primary600", variant: "pi" }, regenerateLabel)), /* @__PURE__ */ react.createElement(
        FieldActionWrapper,
        {
        ...
        isLoading ? /* @__PURE__ */ react.createElement(LoadingWrapper, null, /* @__PURE__ */ react.createElement(Loader/* default */.Z, null)) : /* @__PURE__ */ react.createElement(Refresh/* default */.Z, null)
      )),
      hint,
      label,
      labelAction,
...
const useRelation = (cacheKey, { relation, search }) => {
  ...
  const fetchRelations = async ({ pageParam = 1 }) => {
    try {
      const { data: data2 } = await utils/* axiosInstance.get */.be.get(relation?.endpoint, {
        params: {
          ...relation.pageParams ?? {},
          page: pageParam
        }
  ...
  const fetchSearch = async ({ pageParam = 1 }) => {
    try {
      const { data: data2 } = await utils/* axiosInstance.get */.be.get(search.endpoint, {
        params: {
          ...search.pageParams ?? {},
          ...searchParams,
          page: pageParam
...
const RelationInputDataManager = ({
  ...
  if (!isFieldAllowed && isCreatingEntry || !isCreatingEntry && !isFieldAllowed && !isFieldReadable) {
    return /* @__PURE__ */ react.createElement(build.NotAllowedInput, { name, intlLabel, labelAction });
  }
...
const NonRepeatableComponent = ({ componentUid, isFromDynamicZone, isNested, name }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 6 }, fields.map((fieldRow, key) => {
...
`;
const ActionsStack = (0,styled_components_browser_esm["default"])(dist.Stack)`
  & .drag-handle {
    background: unset;
...
const DraggedItem = ({
  ...
  const { modifiedData, removeRepeatableField, triggerFormValidation } = (0,build.useCMEditViewDataManager)();
  ...
  return /* @__PURE__ */ react.createElement(dist.Box, { ref: composedBoxRefs }, isDragging ? /* @__PURE__ */ react.createElement(components_Preview, null) : /* @__PURE__ */ react.createElement(dist.Accordion, { expanded: isOpen, onToggle: onClickToggle, id: componentFieldName, size: "S" }, /* @__PURE__ */ react.createElement(
    ...
    {
      action: isReadOnly ? null : /* @__PURE__ */ react.createElement(ActionsStack, { horizontal: true, spacing: 0, expanded: isOpen }, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(dist.AccordionContent, null, /* @__PURE__ */ react.createElement(dist.Stack, { background: "neutral100", padding: 6, spacing: 6 }, fields.map((fieldRow, key) => {
    return (
...
const RepeatableComponent = ({
  ...
  const { addRepeatableComponentToField, formErrors, moveComponentField } = (0,build.useCMEditViewDataManager)();
...
const FieldComponent = ({
  ...
  if (!hasChildrenAllowedFields && isCreatingEntry) {
    return /* @__PURE__ */ react.createElement(build.NotAllowedInput, { labelAction, intlLabel, name });
  }
  ...
  )), /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1 }, !isRepeatable && !isInitialized && /* @__PURE__ */ react.createElement(
...
const DynamicComponent_ActionsStack = (0,styled_components_browser_esm["default"])(dist.Stack)`
  /* 
...
`;
const DynamicComponent_StyledBox = (0,styled_components_browser_esm["default"])(dist.Box)`
  > div:first-child {
...
const DynamicZoneComponent = ({
  ...
  const composedBoxRefs = composeRefs(boxRef, dropRef);
  const accordionActions = !isFieldAllowed ? null : /* @__PURE__ */ react.createElement(DynamicComponent_ActionsStack, { horizontal: true, spacing: 0, expanded: isOpen }, /* @__PURE__ */ react.createElement(
    IconButtonCustom,
    {
      noBorder: true,
      label: formatMessage(
  ...
  return /* @__PURE__ */ react.createElement(ComponentContainer, { as: "li" }, /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Rectangle, { background: "neutral200" })), /* @__PURE__ */ react.createElement(DynamicComponent_StyledBox, { ref: composedBoxRefs, hasRadius: true }, isDragging ? /* @__PURE__ */ react.createElement(DynamicComponent_Preview, { padding: 6, background: "primary100" }) : /* @__PURE__ */ react.createElement(dist.Accordion, { expanded: isOpen, onToggle: handleToggle, size: "S", error: errorMessage }, /* @__PURE__ */ react.createElement(
    dist.AccordionToggle,
    {
...
const DynamicZoneLabel = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", justifyContent: "center" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { maxWidth: (0,build.pxToRem)(356) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", fontWeight: "bold", ellipsis: true }, intlLabel, "\xA0"), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", fontWeight: "bold" }, "(", numberOfComponents, ")"), required && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "danger600" }, "*"), labelAction && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 1 }, labelAction)), intlDescription && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1, maxWidth: (0,build.pxToRem)(356) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", ellipsis: true }, formatMessage(intlDescription))))
  )));
};
...
function ComponentCard({ children, onClick }) {
  return /* @__PURE__ */ react.createElement(ComponentBox, { as: "button", type: "button", onClick, hasRadius: true }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 1, alignItems: "center", justifyContent: "center" }, /* @__PURE__ */ react.createElement(ComponentIcon, null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", fontWeight: "bold", textColor: "neutral600" }, children)));
}
...
const DynamicZone = ({
  ...
  const ariaDescriptionId = `${name}-item-instructions`;
  return /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 6 }, dynamicDisplayedComponentsLength > 0 && /* @__PURE__ */ react.createElement(dist.Box, null, /* @__PURE__ */ react.createElement(
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  (0,react.useEffect)(() => {
    ...
    const fetchData = async (source2) => {
      dispatch(getData());
      try {
        const { data: data2 } = await utils/* axiosInstance.get */.be.get(requestURL, { cancelToken: source2.token });
  ...
  const onDelete = (0,react.useCallback)(
    async (trackerProperty) => {
      try {
        ...
        const { data: data2 } = await utils/* axiosInstance.delete */.be["delete"](
  ...
  const onPost = (0,react.useCallback)(
    async (body, trackerProperty) => {
      ...
      try {
        ...
        const { data: data2 } = await utils/* axiosInstance.post */.be.post(endPoint, body);
  ...
  const onDraftRelationCheck = (0,react.useCallback)(async () => {
    try {
      ...
      const numberOfDraftRelations = await utils/* axiosInstance.get */.be.get(endPoint);
  ...
  const onPublish = (0,react.useCallback)(async () => {
    try {
      ...
      const { data: data2 } = await utils/* axiosInstance.post */.be.post(endPoint);
  ...
  const onPut = (0,react.useCallback)(
    async (body, trackerProperty) => {
      ...
      try {
        ...
        dispatch(setStatus("submit-pending"));
        const { data: data2 } = await utils/* axiosInstance.put */.be.put(endPoint, body);
...
var castArray = __webpack_require__(84596);
    ...
    return Object.keys(browserState2).reduce((acc, current) => {
      ...
      switch (attrType) {
        ...
        case "relation": {
          ...
          const connectedRelations = valuesWithPositions.reduce((acc2, relation, currentIndex) => {
            ...
            if (indexOfRelationOnServer === -1 || indexOfRelationOnServer !== currentIndex) {
              return [...acc2, { id: relation.id, position: relation.position }];
            }
            return acc2;
          }, []);
  ...
  const recursivelyFindPathsBasedOnCondition = (attributes) => {
    return Object.entries(attributes).reduce((acc, [key, value]) => {
      ...
      if (value.type === "component") {
        ...
        }).filter((path) => Boolean(path)).map((path) => `${key}.${path}`);
...
const findLeafByPathAndReplace = (endpath, replaceWith) => {
  const findLeafAndReplace = (acc, curr, ind, currentArr) => {
    if (!acc)
      return acc;
    if (ind === currentArr.length - 1 && endpath === curr && acc[curr] !== void 0) {
  ...
  (0,immer_esm["default"])(state, (draftState) => {
    switch (action.type) {
      ...
      case "ADD_REPEATABLE_COMPONENT_TO_FIELD": {
        ...
        const nonRepeatableComponentPaths = recursivelyFindPathsBasedOnConditionSetup(
          allComponents,
          (value) => value.type === "component" && !value.repeatable
        )(componentLayoutData.attributes);
        const componentDataStructure = relationPaths.reduce((acc, current) => {
          const [componentName] = current.split(".");
          if (!repeatableFields.includes(componentName) && !nonRepeatableComponentPaths.includes(componentName)) {
            set_default()(acc, current, []);
          }
          return acc;
        }, defaultDataStructure);
      ...
      case "LOAD_RELATION": {
        ...
        set_default()(draftState, initialDataPath, uniqBy_default()([...valuesToLoad, ...initialDataRelations], "id"));
        set_default()(
          draftState,
          modifiedDataPath,
          uniqBy_default()([...valuesToLoad, ...modifiedDataRelations], "id")
        );
        break;
      }
      ...
      case "INIT_FORM": {
        ...
        const mergeDataWithPreparedRelations = relationalFieldPaths.map((path) => path.split(".")).reduce((acc, currentPaths) => {
          ...
          const existingComponents = castArray_default()(acc[componentName] || []);
          existingComponents.reduce((result, currentEntry) => {
            if (!isNil_default()(get_default()(currentEntry, [`__temp_key__`]))) {
              return result;
            }
            set_default()(currentEntry, [`__temp_key__`], utils_getMaxTempKey(result) + 1);
            return result;
          }, existingComponents);
...
const EditViewDataManagerProvider = ({
  ...
  const handleSubmit = (0,react.useCallback)(
    async (e) => {
      ...
      try {
        ...
        errors = {
          ...errors,
          ...(0,build.getAPIInnerErrors)(err, { getTrad: utils_getTrad })
        };
      }
      dispatch({
        type: "SET_FORM_ERRORS",
  ...
  return /* @__PURE__ */ react.createElement(
    build.ContentManagerEditViewDataManagerContext.Provider,
    {
      value: {
        addComponentToDynamicZone,
        addNonRepeatableComponentToField,
    ...
    isLoadingForData || !isCreatingEntry && !initialData.id ? /* @__PURE__ */ react.createElement(dist.Main, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null)) : /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
...
const SingleTypeFormWrapper = ({ allLayoutData, children, slug }) => {
  ...
  (0,react.useEffect)(() => {
    ...
    const fetchData = async (source2) => {
      ...
      try {
        const { data: data2 } = await utils/* axiosInstance.get */.be.get(SingleTypeFormWrapper_utils_getRequestUrl(`${slug}${searchToSend}`), {
  ...
  const onDelete = (0,react.useCallback)(
    async (trackerProperty) => {
      try {
        trackUsageRef.current("willDeleteEntry", trackerProperty);
        const { data: data2 } = await utils/* axiosInstance.delete */.be["delete"](SingleTypeFormWrapper_utils_getRequestUrl(`${slug}${searchToSend}`));
        toggleNotification({
          type: "success",
          message: { id: utils_getTrad("success.record.delete") }
        });
...
const Information = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "sigma", textColor: "neutral600", id: "additional-information" }, formatMessage({
    id: utils_getTrad("containers.Edit.information"),
    defaultMessage: "Information"
  })), /* @__PURE__ */ react.createElement(dist.Box, { paddingBottom: 4 }, /* @__PURE__ */ react.createElement(dist.Divider, null)), /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2, as: "dl" }, /* @__PURE__ */ react.createElement(
    KeyValuePair,
    {
      label: formatMessage({
  ...
  )), /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2, as: "dl" }, /* @__PURE__ */ react.createElement(
    KeyValuePair,
    {
      label: formatMessage({
...
const Header = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(DialogBody/* DialogBody */.a, { icon: /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null) }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center", style: { textAlign: "center" } }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { id: "confirm-description" }, formatMessage(
      {
    ...
    /* @__PURE__ */ react.createElement(DialogBody/* DialogBody */.a, { icon: /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null) }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2 }, /* @__PURE__ */ react.createElement(FlexTextAlign, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { id: "confirm-description" }, draftCount, formatMessage(
      {
...
const EditView = ({ allowedActions, isSingleType, goBack, slug, id, origin, userPermissions }) => {
  ...
  return /* @__PURE__ */ react.createElement(DataManagementWrapper, { allLayoutData: layout, slug, id, origin }, ({
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": status !== "resolved" }, /* @__PURE__ */ react.createElement(EditView_Header, { allowedActions }), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Grid/* Grid */.r, { gap: 4 }, /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 9, s: 12 }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 6 }, formattedContentTypeLayout.map((row, index) => {
        ...
        return /* @__PURE__ */ react.createElement(
          ...
          /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 6 }, row.map((grid, gridRowIndex) => /* @__PURE__ */ react.createElement(
            EditView_GridRow,
            {
              columns: grid,
              customFieldInputs: lazyComponentStore,
      ...
      }))), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 3, s: 12 }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2 }, /* @__PURE__ */ react.createElement(EditView_DraftAndPublishBadge, null), /* @__PURE__ */ react.createElement(
        Box/* Box */.x,
        {
          as: "aside",
      ...
      ), /* @__PURE__ */ react.createElement(Box/* Box */.x, { as: "aside", "aria-labelledby": "links" }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2 }, /* @__PURE__ */ react.createElement(components_InjectionZone, { area: "contentManager.editView.right-links", slug }), slug !== "strapi::administrator" && /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions: ctbPermissions }, /* @__PURE__ */ react.createElement(
        build.LinkButton,
        {
          onClick: () => {
      ...
      )), /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions: configurationPermissions }, /* @__PURE__ */ react.createElement(
        build.LinkButton,
        {
          size: "S",
...
const DynamicZoneList = ({ components }) => {
  const { componentLayouts } = hooks_useLayoutDnd();
  return /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 2, horizontal: true, overflow: "scroll hidden", padding: 3 }, components.map((componentUid) => /* @__PURE__ */ react.createElement(
    CustomLink,
    {
      hasRadius: true,
      background: "neutral0",
...
`;
const DisplayedFieldButton_DragButton = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  cursor: all-scroll;
  border-right: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
...
const LinkToCTB = () => {
  ...
  return /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions: LinkToCTB_permissions }, /* @__PURE__ */ react.createElement(
    build.LinkButton,
    {
...
const DisplayedFields = ({ editLayout, fields, onRemoveField, onAddField }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, formatMessage({
...
const fetchRelation = async (endPoint, notifyStatus) => {
  ...
  } = await utils/* axiosInstance.get */.be.get(endPoint);
  notifyStatus();
...
const RelationMultiple = ({ fieldSchema, metadatas, name, entityId, value, contentType }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { ...build.stopPropagation }, /* @__PURE__ */ react.createElement(
    SimpleMenu/* SimpleMenu */.O,
    {
      label: Label,
      size: "S",
...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data, index) => {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      withMainAction && /* @__PURE__ */ react.createElement(Cell.Td, { ...build.stopPropagation }, /* @__PURE__ */ react.createElement(
      ...
      withBulkActions && /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "end", ...build.stopPropagation }, /* @__PURE__ */ react.createElement(
        IconButton/* IconButton */.h,
        {
...
const ConfirmDialogDeleteAll = ({ isConfirmButtonLoading, isOpen, onToggleDialog, onConfirm }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(DialogBody/* DialogBody */.a, { icon: /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null) }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { id: "confirm-description" }, formatMessage({
...
const StyledStatus = (0,styled_components_browser_esm["default"])(Status/* Status */.q)`
  width: min-content;
`;
const DynamicTable = ({
  canCreate,
...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(build.PageSizeURLQuery, { trackedEvent: "willChangeNumberOfEntriesPerPage" }), /* @__PURE__ */ react.createElement(build.PaginationURLQuery, { pagination })));
};
...
function ListView({
  ...
  const fetchData = (0,react.useCallback)(
    async (endPoint, source) => {
      ...
      try {
        ...
        } = await utils/* axiosInstance.get */.be.get(endPoint, opts);
        notifyStatus(
          formatMessage(
            {
  ...
  const handleConfirmDeleteAllData = (0,react.useCallback)(
    async (ids) => {
      try {
        await utils/* axiosInstance.post */.be.post(utils_getRequestUrl(`collection-types/${slug}/actions/bulkDelete`), {
          ids
        });
  ...
  const handleConfirmDeleteData = (0,react.useCallback)(
    async (idToDelete) => {
      try {
        await utils/* axiosInstance.delete */.be["delete"](utils_getRequestUrl(`collection-types/${slug}/${idToDelete}`));
        const requestUrl = utils_getRequestUrl(`collection-types/${slug}${params}`);
        fetchData(requestUrl);
        toggleNotification({
          type: "success",
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(build.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/content-manager/" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
    ...
    {
      endActions: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(components_InjectionZone, { area: "contentManager.listView.actions" }), /* @__PURE__ */ react.createElement(ListView_FieldPicker, { layout }), /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions: ListView_cmPermissions.collectionTypesConfigurations }, /* @__PURE__ */ react.createElement(ConfigureLayoutBox, { paddingTop: 1, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(
        IconButton/* IconButton */.h,
        {
          onClick: () => {
  ...
  ), /* @__PURE__ */ react.createElement(ListView_PaginationFooter, { pagination: { pageCount: pagination?.pageCount || 1 } })) : /* @__PURE__ */ react.createElement(build.NoPermissions, null)));
}
ListView.propTypes = {
  canCreate: (prop_types_default()).bool.isRequired,
  canDelete: (prop_types_default()).bool.isRequired,
...
const Settings = ({ modifiedData, onChange, sortOptions }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { spacing: 4 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "delta", as: "h2" }, formatMessage({
    id: utils_getTrad("containers.SettingPage.settings"),
    defaultMessage: "Settings"
  })), /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, justifyContent: "space-between", spacing: 4 }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { width: "100%" }, /* @__PURE__ */ react.createElement(
    ToggleInput/* ToggleInput */.s,
    {
      label: formatMessage({
...
`;
const DraggableCard_FieldWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  &:last-child {
...
const DraggableCard = ({
  ...
  return /* @__PURE__ */ react.createElement(DraggableCard_FieldWrapper, { ref: refs ? refs.dropRef : null }, isDragging && /* @__PURE__ */ react.createElement(components_CardPreview, { transparent: true, labelField: cardEllipsisTitle }), !isDragging && isDraggingSibling && /* @__PURE__ */ react.createElement(components_CardPreview, { isSibling: true, labelField: cardEllipsisTitle }), !isDragging && !isDraggingSibling && /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 3 }, /* @__PURE__ */ react.createElement(
      DraggableCard_DragButton,
      {
        as: "span",
        "aria-label": formatMessage(
...
const FlexWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  flex: ${({ size }) => size};
`;
const ScrollableContainer = (0,styled_components_browser_esm["default"])(FlexWrapper)`
  overflow-x: scroll;
  overflow-y: hidden;
`;
const SelectContainer = (0,styled_components_browser_esm["default"])(FlexWrapper)`
  max-width: ${32 / 16}rem;
`;
const SortDisplayedFields = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "delta", as: "h2" }, formatMessage({
    ...
    /* @__PURE__ */ react.createElement(ScrollableContainer, { size: "1", paddingBottom: 4, ref: scrollableContainerRef }, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, { horizontal: true, spacing: 3 }, displayedFields.map((field, index) => /* @__PURE__ */ react.createElement(
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isSubmittingForm }, /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      navigationAction: /* @__PURE__ */ react.createElement(build.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: goBackUrl, id: "go-back" }, formatMessage({ id: "global.back", defaultMessage: "Back" })),
      primaryAction: /* @__PURE__ */ react.createElement(
        Button/* Button */.z,
        {
          size: "S",
...
const ErrorFallback = () => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { padding: 8 }, /* @__PURE__ */ react.createElement(build.AnErrorOccurred, null));
};
...
const CollectionTypeRecursivePath = ({
  ...
  ))), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: `${url}/configurations/edit` }, /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: CollectionTypeRecursivePath_cmPermissions.collectionTypesConfigurations }, /* @__PURE__ */ react.createElement(
...
const ComponentSettingsView = () => {
  ...
  (0,react.useEffect)(() => {
    ...
    const fetchData = async (source2) => {
      try {
        ...
        const {
          data: { data }
        } = await utils/* axiosInstance.get */.be.get(utils_getRequestUrl(`components/${uid}/configuration`), {
          cancelToken: source2.token
        });
  ...
  return /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: ComponentSetttingsView_cmPermissions.componentsConfigurations }, /* @__PURE__ */ react.createElement(pages_EditSettingsView, { components: layout.components, mainLayout: layout.component, slug: uid }));
};
...
const NoContentType = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(
    ...
    EmptyStateLayout/* EmptyStateLayout */.x,
    {
      ...
      hasRadius: true,
      icon: /* @__PURE__ */ react.createElement(EmptyDocuments["default"], { width: "10rem" }),
      shadow: "tableShadow"
    }
  )));
};
...
const NoPermissions = () => {
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(build.NoPermissions, null)));
};
...
const getContentTypeLinks = async (models, userPermissions, toggleNotification) => {
  try {
    ...
    } = await utils/* axiosInstance.get */.be.get(utils_getRequestUrl("content-types-settings"));
...
const App = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, { sideNav: /* @__PURE__ */ react.createElement(App_LeftMenu, null) }, /* @__PURE__ */ react.createElement(DragLayer, null), /* @__PURE__ */ react.createElement(contexts_ModelsContext.Provider, { value: { refetchData } }, /* @__PURE__ */ react.createElement(react_router_dom_min.Switch, null, /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: "/content-manager/components/:uid/configurations/edit" }, /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: App_cmPermissions.componentsConfigurations }, /* @__PURE__ */ react.createElement(ComponentSetttingsView, null))), /* @__PURE__ */ react.createElement(
    react_router_dom_min.Route,
    {
      path: "/content-manager/collectionType/:slug",
      component: pages_CollectionTypeRecursivePath
    }
  ), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: "/content-manager/singleType/:slug", component: pages_SingleTypeRecursivePath }), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: "/content-manager/403" }, /* @__PURE__ */ react.createElement(pages_NoPermissions, null)), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: "/content-manager/no-content-types" }, /* @__PURE__ */ react.createElement(pages_NoContentType, null)), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: "", component: build.NotFound }))));
};
