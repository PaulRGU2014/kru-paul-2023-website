"use strict";
(self["webpackChunkproject_kru_2023"] = self["webpackChunkproject_kru_2023"] || []).push([[5199],{
...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data) => {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      ), canDelete && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 1, ...build.stopPropagation }, /* @__PURE__ */ react.createElement(
        IconButton/* IconButton */.h,
        {
...
const fetchData = async (search, notify) => {
  const {
    data: { data }
  } = await core_utils/* axiosInstance.get */.be.get(`/admin/users${search}`);
  notify();
  return data;
};
const deleteData = async (ids) => {
  await core_utils/* axiosInstance.post */.be.post("/admin/users/batch-delete", { ids });
};
...
const ListPage = () => {
  ...
  ), /* @__PURE__ */ react.createElement(ListPage_PaginationFooter, { pagination: data?.pagination }))), isModalOpened && /* @__PURE__ */ react.createElement(ListPage_ModalForm, { onToggle: handleToggle, queryName }));
};
