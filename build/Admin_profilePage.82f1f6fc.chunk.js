"use strict";
(self["webpackChunkproject_kru_2023"] = self["webpackChunkproject_kru_2023"] || []).push([[9497],{
...
const fetchUser = async () => {
  const { data } = await utils/* axiosInstance.get */.be.get("/admin/users/me");
  return data.data;
};
const putUser = async (body) => {
  const dataToSend = omit_default()(body, ["confirmPassword", "currentTheme"]);
  const { data } = await utils/* axiosInstance.put */.be.put("/admin/users/me", dataToSend);
